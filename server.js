...
let CMA_COOKIES = (process.env.CMA_COOKIES || "")
  ...
  .trim();
// Sync initial value to helpers so trackers.js sees the same cookie string.
helpers.setCmaCookies(CMA_COOKIES);
...
app.post("/api/cookies", (req, res) => {
  ...
  if (car === "cma") {
    ...
    CMA_COOKIES = clean;
    helpers.setCmaCookies(clean); // keep trackers.js in sync
