...
const CMA_COOKIES = process.env.CMA_COOKIES || "_pk_ref.1.d313=%5B%22%22%2C%22%22%2C1775005726%2C%22https%3A%2F%2Fwww.google.com%2F%22%5D; _pk_id.1.d313=6c3ab2502977d58d.1775005726.; _cs_c=0; ABTasty=uid=n4yy5g8c94x4r6ay&fst=1775005725963&pst=-1&cst=1775005725963&ns=1&pvt=2&pvis=2&th=; OptanonConsent=isGpcEnabled=0&datestamp=Tue+Mar+31+2026+22%3A10%3A25+GMT-0300+(Hor%C3%A1rio+Padr%C3%A3o+de+Bras%C3%ADlia)&version=202601.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&genVendors=V3%3A0%2C&consentId=9a47a91e-90e8-4ef4-95a9-599c6b4f5d05&interactionCount=1&isAnonUser=1&prevHadToken=0&landingPath=https%3A%2F%2Fwww.cma-cgm.com%2F&groups=C0001%3A1%2CC0002%3A1%2CC0003%3A1%2CC0004%3A1&crTime=1775005789825; _cs_id=fabb3850-475c-aad9-f8c2-173cf42a35b9.1775005726.1.1775005826.1775005726.1756456642.1809169726276.1.x; MustRelease=1.0.0.0; XSRF-TOKEN=CfDJ8A8NLHDLTiZMoq8qy5oEhkQj6Leok-SgfuTw3e2dBHAlg7Exahzdg2cruG9NAjME14Zdd35xgDZXCcRYvVbRdGGPltEnRgGfylw9xvB5Dkxb-fKL9Qy9ibtMTiOuxYpTlKA67IxMxBw4JIiN4A3vD6U; dtCookie=v_4_srv_6_sn_E9E5833291F9E9CDDBB289E663869606_perc_100000_ol_0_mul_1_app-3A0b422508580a7b79_0_rcs-3Acss_0; .AspNetCore.Session=CfDJ8A8NLHDLTiZMoq8qy5oEhkRyaKTgsGtWCpfcPvrby17inaz6hYzrMcmKLr8jse1JoLTgunPjO1t8edBPIQwRKShIT%2Fv1LdXMdfZIN%2FMBOv12xlXFFWdHJfAf%2B7hzXapVhEN7Y9mZY058S4sxb78lKH7xe4jwt1n%2BF3TbUWIGZsF%2B; Human_Search=1; datadome=8XfSlKyC9bizZA9N2bgs9TpjQXbbF7ZqxtUHqNbcFaX6pI9o9nA9okftCNjF0ogxZDYpdgxFeVBMwJu~MGgisKJUUqK1ht~uu5tXkw229ALkvRqJZ1kSVUaHYTrbzlBR";
...
function parseCmaSchedules(rawHtml, polName, podName, polCode, podCode) {
  ...
  fs.writeFileSync("parsed-text.txt", text);
  const sailings = [];
  let match;
...
app.get("/api/cma", async (req, res) => {
  ...
  try {
    ...
    // Debug: save HTML
    fs.writeFileSync("debug.html", result.body);
    ...
    if (sailings.length === 0) {
      fs.writeFileSync("routing-finder-response.html", result.body);
      return res.status(502).json({
