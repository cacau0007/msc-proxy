...
- 1. Replace the return notImplemented(...) with real fetch logic
- 1. Map the API’s response to the standard shape (see normalizedShape below)
- 1. Done — the frontend already knows how to render it.
- 
